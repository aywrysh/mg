...
['تغيير اللغة','Change language'],
 ...
 ['عذرًا، هذا الحساب موقّف','Sorry, this account is suspended. '],
  ...
  ['ربط الكمبيوتر','Link Computer'],
  ['كود الربط','Link Code'],
  ['توليد','Generate'],
  ['نسخ','Copy'],
  ['تحديث','Refresh'],
  ['—','—'],
  ['الكود صالح','Code valid for'],
  ['دقائق','minutes'],
  ['عند إدخال الكود في الكمبيوتر سيظهر لك طلب موافقة هنا','When you enter the code on the computer, an approval request will appear here'],
  ['⚠ لا تشارك الكود مع أي شخص','⚠ Do not share the code with anyone'],
  ['الجهاز المتصل','Connected Device'],
  ...
  ['إذا حذفت الجلسة سيتم فصل الكمبيوتر فورًا (إذا كانت صفحة الكمبيوتر تراقب حالة الجلسة)','If you delete the session, the computer will be disconnected immediately (if the computer page is monitoring the session state)'],
  ['طلب ربط كمبيوتر','Computer Link Request'],
  ['طلب ربط جديد','New Linking Request'],
  ['الكود','Code'],
  ['الوقت','Time'],
  ['معلومات الجهاز','Device Info'],
  ['رفض','Reject'],
  ['موافقة','Approve'],
  ['⚠ إذا أنت ما طلبت ربط كمبيوتر، اضغط رفض','⚠ If you did not request to link a computer, press Reject'],
  ...
  ['link_off','disconnect'],
  ['✕','✕'],
  ['الرجاء تسجيل الدخول','Please login'],
  ['لازم تسجّل دخول من الجوال أولاً','You must login from your phone first'],
  ['لا توجد جلسة مستخدم','No user session'],
  ['تم توليد الكود','Code generated'],
  ['تم النسخ','Copied'],
  ['ولّد كود أولاً','Generate a code first'],
  ['تم التحديث','Refreshed'],
  ['فشل التحديث','Refresh failed'],
  ['انتهت صلاحية الكود','Code expired'],
  ['متبقي:','Left:'],
  ['تم حذف الجلسة','Session deleted'],
  ['تعذر حذف الجلسة','Failed to delete session'],
  ['تعذّر تنفيذ العملية','Operation failed'],
  ['Dynex – تسجيل دخول','Dynex – Sign in'],
  ['تسجيل دخول','Sign in'],
  ['اسم المستخدم','Username'],
  ['كلمة السر','Password'],
  ...
  ['status','status'],
  ['decidedAt','decidedAt'],
  ['ايقونةخروج.png','exit-icon.png'],
  ['ايقوناتتواصل.png','support-icon.png'],
  ['ايقونةترجمه.png','translate-icon.png'],
  ['عرض الجهاز','Device Display'],
  ['سطر معلومات الجهاز','Device Info Line'],
  ['كود','Code'],
  ['صغير','Small'],
  ['شارة','Badge'],
  ['أفعال','Actions'],
  ...
  ['TEXT','TEXT'],
  ['SESSION','SESSION'],
  ['Dynex | ربط الكمبيوتر','Dynex | Link Computer'],
  ['✅ الكود صالح 10 دقائق.','✅ Code valid for 10 minutes.'],
  ['✅ عند إدخال الكود في الكمبيوتر سيظهر لك طلب موافقة هنا.','✅ When you enter the code on the computer, an approval request will appear here.'],
  ['⚠ لا تشارك الكود مع أي شخص.','⚠ Do not share the code with anyone.'],
  ['<b>10 دقائق</b>','<b>10 minutes</b>'],
  ['<b>رفض</b>','<b>Reject</b>'], 
